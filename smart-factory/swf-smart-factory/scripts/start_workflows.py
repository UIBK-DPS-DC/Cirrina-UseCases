...
if __name__ == "__main__":
    ...
    parser.add_argument("--workflows", type=str, required=False, default="job_control,robotic_arm,conveyor_belt,camera_sensor,photoelectric_sensor_start,photoelectric_sensor_end")
    parser.add_argument("--key", type=str, required=False, default="instance1")
    parser.add_argument("--products", type=int, required=False, default=100)
    parser.add_argument("--parts", type=int, required=False, default=10)
